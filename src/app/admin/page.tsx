    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <Link href="/admin/ships" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-[#2563EB] rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7M5 13l4 4L19 7" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M3 12l18 0M3 6l18 0M3 18l18 0" />
                    </svg>
                  </div>
                  <h3 className="ml-3 text-lg font-semibold text-gray-900">Manage Ships</h3>
                </div>
                <p className="text-gray-800 mb-4">Add, edit, and manage your fleet of cruise ships and expedition vessels.</p>
                <div className="flex items-center text-[#B8860B] font-medium">
            ...
            <Link href="/admin/blog" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-[#B8860B] rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m0 0h2a2 2 0 012 2v.5M17 7v6m0 0l3-3m-3 3l-3-3M9 8h4M9 12h2" />
                    </svg>
                  </div>
                  <h3 className="ml-3 text-lg font-semibold text-gray-900">Blog / SEO Guides</h3>
                </div>
                <p className="text-gray-800 mb-4">Write and publish travel guides that bring in organic search traffic.</p>
                <div className="flex items-center text-[#B8860B] font-medium">
            ...
            <Link href="/admin/hero-images" className="block">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-3 text-lg font-semibold text-gray-900">Hero Images</h3>
                </div>
                <p className="text-gray-800 mb-4">Manage hero banner images and set focal points for each page.</p>
                <div className="flex items-center text-[#B8860B] font-medium">
