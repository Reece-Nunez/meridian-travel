...
const FAQ_INDICES = [1, 2, 3, 4, 5, 6] as const;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                <div className="w-12 h-12 bg-[#B8860B] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                  <svg className="w-6 h-6 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {CONTACT_METHODS[0].icon}
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#8B4513] mb-2">Phone</h3>
                  <ContentLoader
                    isLoading={isLoading}
                    skeleton={
                  ...
                  >
                    <p className="text-gray-600 mb-2">
                      <a href={phoneHref} className="hover:text-[#B8860B] transition-colors">{phone}</a>
                    </p>
                    {businessHours && (
              ...
              <div className="flex items-start">
                <div className="w-12 h-12 bg-[#B8860B] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                  <svg className="w-6 h-6 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {CONTACT_METHODS[1].icon}
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#8B4513] mb-2">Email</h3>
                  <ContentLoader
                    isLoading={isLoading}
                    skeleton={
                      <div className="space-y-2">
                  ...
                  >
                    <p className="text-gray-600 mb-2">
                      <a href={emailHref} className="hover:text-[#B8860B] transition-colors">{email}</a>
                    </p>
                    <p className="text-sm text-gray-500">{getContent('contact_email_response')}</p>
                  </ContentLoader>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <div className="w-12 h-12 bg-[#B8860B] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                  <svg className="w-6 h-6 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {CONTACT_METHODS[2].icon}
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#8B4513] mb-2">Office</h3>
                  <ContentLoader
                    isLoading={isLoading}
                    skeleton={
                      <div className="space-y-2">
              ...
              <div className="flex items-start">
                <div className="w-12 h-12 bg-[#B8860B] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                  <svg className="w-6 h-6 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {CONTACT_METHODS[3].icon}
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#8B4513] mb-2">Emergency Support</h3>
                  <ContentLoader
                    isLoading={isLoading}
                    skeleton={
                      <div className="space-y-2">
                  ...
                  >
                    <p className="text-gray-600 mb-2">
                      <a href={emergencyPhoneHref} className="hover:text-[#B8860B] transition-colors">{emergencyPhone}</a>
                    </p>
                    <p className="text-sm text-gray-500">{getContent('contact_emergency_text')}</p>
                  </ContentLoader>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 p-6 bg-[#F5F5DC] rounded-lg">
              ...
              >
                ...
                <p className="text-gray-600 mb-6">{getContent('contact_quick_action_content')}</p>
                <Link
                  href="/quote"
          ...
          >
            ...
            <div className="space-y-6">
              {FAQ_INDICES.map((n) => (
                <div key={n} className={n < 6 ? "border-b border-gray-200 pb-6" : "pb-6"}>
                  <ContentLoader
                    isLoading={isLoading}
                    skeleton={
                  ...
                  >
                    <h3 className="text-lg font-semibold text-[#8B4513] mb-2">
                      {getContent(`contact_faq_${n}_question`)}
                    </h3>
                    <p className="text-gray-600">
                      {getContent(`contact_faq_${n}_answer`)}
                    </p>
                  </ContentLoader>
                </div>
              ))}
      ...
      <div className="bg-[#F5F5DC] py-16">
        <div className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">{getContent('contact_cta_subtitle')}</p>
          </ContentLoader>
          <ContentLoader
            isLoading={isLoading}
            skeleton={
