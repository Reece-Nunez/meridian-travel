        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-2">
                    <a href="tel:+1-555-0123" className="hover:text-blue-900 transition-colors">
                      +1 (555) 012-3456
                    </a>
                  </p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-2">
                    <a href="mailto:info@meridiantravel.com" className="hover:text-blue-900 transition-colors">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-2">
                    <a href="tel:+1-555-0199" className="hover:text-blue-900 transition-colors">
                      +1 (555) 019-9999
                    </a>
                  </p>
                  <p className="text-sm text-gray-500">
            ...
            <div className="mt-12 p-6 bg-blue-50 rounded-lg">
              ...
              <Link
                href="/quote"
                className="bg-blue-900 hover:bg-blue-800 text-white px-6 py-3 rounded-md font-medium transition-colors duration-200"
              >
                Request Your Quote
              </Link>
            </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="border-2 border-blue-900 text-blue-900 hover:bg-blue-50 px-8 py-4 rounded-md text-lg font-medium transition-colors duration-200"
            >
              Send an Email
            </a>
          </div>
