...
export default function AntarcticaDestination() {
  ...
  const heroSettings = useHeroSettings('antarctica', 'https://meridian-travel.s3.us-east-1.amazonaws.com/antarctica.webp');

  // Scroll restoration for refresh and back button navigation
  usePercentageScrollRestoration('destination-antarctica', !loading);
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white max-w-4xl">
            ...
            >
              <Link
                href="/cruises?location=Antarctica"
