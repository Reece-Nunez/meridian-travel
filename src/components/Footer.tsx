          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              {SOCIAL_ICONS.map((social) => (
                <a key={social.name} href="#" className="text-[#F5F5DC] hover:text-[#B8860B] transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {DESTINATIONS.map((dest) => (
                <li key={dest.href}>
                  <Link href={dest.href} className="text-[#F5F5DC] hover:text-[#B8860B] transition-colors duration-200">
                    {dest.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {COMPANY_LINKS.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-[#F5F5DC] hover:text-[#B8860B] transition-colors duration-200">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center md:justify-end space-x-6">
              {LEGAL_LINKS.map((link) => (
                <Link key={link.href} href={link.href} className="text-[#F5F5DC] hover:text-[#B8860B] text-sm transition-colors duration-200">
                  {link.name}
                </Link>
              ))}
            </div>
